            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-12">
                ...
                <div class="relative p-4 w-full h-full md:h-auto">
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <!-- Modal body -->
                        <form action="{{ route('user.payment.create', ['form' => $form]) }}" method="POST"
                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                <div>
                                    <div class="max-w-sm rounded-lg shadow ">
                                        <img class="rounded-t-lg" src="{{ asset('storage/images/' . 'qrcode.png') }}"
                                            alt="" />
                                    </div>
                                </div>
                                <div>
                                    <div class="border-b pb-2">
                                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pick &
                                            Drop:
                                            {{ $form->pick }} to {{ $form->drop }}</label>
                                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date:
                                            {{ $form->check_in }} to {{ $form->check_out }}</label>
                                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deposit:
                                            500 Baht. ( Total Price: {{ $car->price * $form->date_difference }} Baht.
                                            )</label>
                                    </div>
                                    <div>
                                        <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                                            <div class="pt-2">
                                                ...
                                                <input type="text" name="first_name" id="first_name"
                                                    ...
                                                    value="{{ $form->user->first_name }}" required="">
                                            </div>
                                            <div class="pt-2">
                                                <label for="last_name"
                                                ...
                                                <input type="text" name="last_name" id="last_name"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    value="{{ $form->user->last_name }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-4"></div>
                                                ...
                                                <script>
                                                    $(function() {
                                                        $('input[name="date"]').daterangepicker({
                                                            ...
                                                            minDate: moment(),
                                                            maxDate: moment().startOf('hour').add(1, 'hour'),
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            name="image_path" id="image_path" type="file" required="">
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="image_path"></p>
                                    </div>
                                    <div class="my-4"></div>
                                    <div>
                                        @if (Route::has('login'))
