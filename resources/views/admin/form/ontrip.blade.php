                            ...
                            @foreach ($forms as $form)
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <form action="{{ route('admin.form.update', ['form' => $form]) }}" method="POST">
                                            @method('PUT')
                                            @csrf
                                            <button type="sumbit"
                                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">End
                                                Trip</button>
                                        </form>
                                    </td>
                                </tr>
