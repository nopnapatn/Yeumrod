                                                    ...
                                                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
                                                        <div class="">
                                                            @if ($form->payment->isNotEmpty())
                                                                <img class="rounded"
                                                                    src="{{ asset('storage/' . $form->payment->first()->image_path) }}"
                                                                    alt="Payment Image" />
                                                            @else
                                                                <p>No payment image available for this form.</p>
                                                            @endif
                                                        </div>
                                                        <div class="">
                                                            @if ($form->payment->isNotEmpty())
                                                                ...
                                                                <dl>
                                                                    ...
                                                                    <dd
                                                                        class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                                                        Date: {{ $form->payment->first()->date }} <br>
                                                                        Amount: 500 Baht.
                                                                    </dd>
                                                                    <dt
                                                                        class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                            ...
                                                            @else
                                                                ...
                                                                <script>
                                                                    // Define the target date as 24 hours from the created_at timestamp
                                                                    const createdTimestamp = new Date("{{ $form->created_at }}"); // Replace with the created_at timestamp
                                                                    const targetDate = new Date(createdTimestamp.getTime() + 24 * 60 * 60 * 1000);
                                                                    ...
                                                                    function updateCountdown() {
                                                                        ...
                                                                        if (timeRemaining <= 0) {
                                                                            document.getElementById("countdown-timer").innerHTML = "Timer expired!";
                                                                            return;
                                                                        }
