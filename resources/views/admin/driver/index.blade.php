        ...
        <div class=" overp-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="p-4">
                <a href="{{ route('driver.create') }}"
                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Create Driver</a>
                            ...
                            <tr>
                                <th scope="col" class="px-6 py-3">
                                    <div class="flex item-center">
                                        @sortablelink('id', 'Driver Id')<svg class="w-3 h-3 ml-1.5" aria-hidden="true"
                ...
                <nav class="flex items-center justify-between pt-4" aria-label="Table navigation">
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">Showing
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $drivers->firstItem() }}</span> to
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $drivers->lastItem() }}</span> of
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $drivers->total() }}</span> results
                    </span>
